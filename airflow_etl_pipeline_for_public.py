...
def extract_customer_data(**kawrgs):
    ...
    pd.read_sql(sql=f"select * from `customer`", con=conn).to_csv("/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/extract_product_data.csv", index=False)
...
def extract_product_data(**kawrgs):
    ...
    pd.read_sql(sql=f"select * from `product`", con=conn).to_csv("/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/extract_product_data.csv", index=False)
...
def extract_order_data(**kawrgs):
    ...
    pd.read_sql(sql=f"SELECT * FROM `order` o JOIN `order-item` oi ON o.order_id=oi.order_id ", con=conn).to_csv("/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/extract_order_data.csv", index=False)
...
def extract_date_data():
    ...
    date_dimension.to_csv("/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/date.csv", index=False)
...
def transform_customer_data():
    df = pd.read_csv("/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/extract_customer_data.csv")
    ...
    # store data locally
    df.to_csv("/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/transformed_customer_data.csv", index=False)


def transform_product_data():
    
    df = pd.read_csv("/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/extract_product_data.csv")
    ...
    df.to_csv("/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/transformed_product_data.csv", index=False)


def transform_order_data():
    
    df = pd.read_csv("/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/extract_order_data.csv")
    ...
    df.to_csv("/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/transformed_order_data.csv", index=False)
...
#  stagged data 
    df = pd.read_csv('/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/transformed_customer_data.csv')
...
def load_product_data():
    ...
    #  stagged data 
    df = pd.read_csv('/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/transformed_product_data.csv')
...
def load_order_data():
    ...
    #  stagged data 
    df = pd.read_csv('/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/transformed_order_data.csv')
...
def load_date_data():
    try :
        ...
        conn = Connect(
            ...
            password="password",  # password leave it blank if there isn't any
            port="3306",    # port (3306 default)
            db="datawarehouse",    # name of the database
        )  
    ...
    #  stagged data 
    df = pd.read_csv('/Users/junaidpatel/Downloads/Data_Engineering/Jupyter_Notebook/Portfolio/Airflow_ETL_Project/Data/date.csv')
